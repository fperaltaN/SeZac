        ...
        <div class="small-12 medium-12 large-6 columns">
            <div class="small-12 medium-12 large-12 columns">
                <header class="small-12 medium-12 large-12 columns">
                  ...
                  <div class="small-10 medium-10 large-11 columns separa_v_xl" align="justify">
                     <h4>Ingresa como estudiante / docente.</h4>
                  </div>
               </header>
                ...
                <div class="small-12 medium-12 large-12 columns separa_v">
                    <input type="button" class="btn btn-flat btn-primary button expand" id="sesion-start-a"
                        value="Inicia sesión">
                </div>
            ...
            <div class="small-12 medium-12 large-12 columns">
                <header class="small-12 medium-12 large-12 columns">
                  ...
                  <div class="small-10 medium-10 large-11 columns separa_v_xl" align="justify">
                     <h4>Ingresa como institución.</h4>
                  </div>
               </header>
                <div class="small-12 medium-6 large-6 columns separa_v">
                    <input type="text" class="large-12.columns" id="lg-inst" onkeyup="this.value=this.value.toUpperCase();"
                        maxlength="18" placeholder="USUARIO">
                </div>
                <div class="small-12 medium-6 large-6 columns separa_v">
                    <input type="password" class="large-12.columns" id="lg-pass_inst" name="lg-pass_inst"
                        placeholder="CONTRASEÑA">
                </div>
                <div class="small-12 medium-12 large-12 columns separa_v">
                    <input type="button" class="btn btn-flat btn-primary button expand" id="sesion-start-i"
                        value="Inicia sesión">
                </div>
